...
export const SPLASH_WORDMARK_LETTER_RISE_PX = 2;
...
export const SPLASH_WORDMARK_LETTER_EASE = [0.33, 1, 0.68, 1] as const;

/** Time-reversed ease for wordmark letter rise on exit. */
export const SPLASH_WORDMARK_LETTER_EXIT_EASE = [0.32, 0, 0.67, 0] as const;

/** Opacity ease-out on wordmark letter entrance. */
export const SPLASH_WORDMARK_LETTER_ENTER_OPACITY_EASE = [0.4, 0, 0.2, 1] as const;

/** Time-reversed opacity ease for wordmark letter exit. */
export const SPLASH_WORDMARK_LETTER_EXIT_OPACITY_EASE = [0.8, 0, 0.67, 0] as const;
