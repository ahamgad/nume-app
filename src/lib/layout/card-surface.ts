...
/** Shared card border radius — account cards, type picker cards, dashboard widgets, form sections. */
...
/** Flat card surface without shadow — dashboard widgets, form sections. */
