export const en = {
  ...
  auth: {
    ...
    errors: {
      ...
      emailSendRateLimitRetryMinutes: "Try again in {count} minutes",
  ...
  more: {
    ...
    profile: {
      ...
      detailsSection: "Personal details",
      name: "Full name",
      ...
      photoSaveSuccess: "Photo updated",
      photoRemoveSuccess: "Photo removed",
      birthdate: "Birthdate",
      birthdatePlaceholder: "Add birthdate",
      gender: "Gender",
