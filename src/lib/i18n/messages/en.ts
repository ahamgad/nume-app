export const en = {
  ...
  certificates: {
    ...
    details: {
      ...
      remainingDaysCount: "{count} days remaining",
      remainingDayCount: "1 day remaining",
      remainingMonthCount: "1 month remaining",
      remainingMonthsCount: "{count} months remaining",
      remainingYearCount: "1 year remaining",
      remainingYearsCount: "{count} years remaining",
      status: "Status",
