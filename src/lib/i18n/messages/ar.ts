...
export const ar = {
  ...
  certificates: {
    ...
    details: {
      ...
      remainingDaysCount: "{count} يومًا متبقية",
      remainingDayCount: "يوم واحد متبقٍ",
      remainingMonthCount: "شهر واحد متبقٍ",
      remainingMonthsCount: "{count} أشهر متبقية",
      remainingYearCount: "سنة واحدة متبقية",
      remainingYearsCount: "{count} سنوات متبقية",
      status: "الحالة",
