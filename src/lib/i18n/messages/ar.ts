...
export const ar = {
  ...
  auth: {
    ...
    errors: {
      emailSendRateLimit: "يرجى الانتظار قبل طلب رمز جديد",
      emailSendRateLimitRetrySecond: "حاول مرة أخرى خلال {count} ثانية",
      emailSendRateLimitRetrySeconds: "حاول مرة أخرى خلال {count} ثوانٍ",
      emailSendRateLimitRetryMinute: "حاول مرة أخرى خلال {count} دقيقة",
      emailSendRateLimitRetryMinutes: "حاول مرة أخرى خلال {count} دقائق",
    ...
    continue: {
      ...
      otpDigitAriaLabel: "{label}، الرقم {current} من {total}",
      otpSubmit: "متابعة",
  ...
  more: {
    ...
    profile: {
      ...
      detailsSection: "البيانات الشخصية",
      name: "الاسم الكامل",
      ...
      photoSaveSuccess: "تم تحديث الصورة",
      photoRemoveSuccess: "تم إزالة الصورة",
      birthdate: "تاريخ الميلاد",
      birthdatePlaceholder: "أضف تاريخ الميلاد",
      gender: "النوع",
